...
const XAIRule xai_rules[] = {
  ...
  {"TCP", 0.8093f, true, 2, "Probe detected: TCP is above normal range, consistent with network reconnaissance."},
  {"Header_Length", 0.4271f, false, 2, "Probe detected: Header_Length is below normal range, consistent with network reconnaissance."},
  {"AVG", 0.0378f, false, 2, "Probe detected: AVG is below normal range, consistent with network reconnaissance."},
